...
class PetOwner:
    def __init__(self, owne_name, pet_id):
...
def rle_encoding(string):
    ...
    for i in range(1, len(string)):
        ...
        if char != charr or lengh == 9:
            encode.append(str(lengh))
            encode.append(charr)
            lengh = 0
